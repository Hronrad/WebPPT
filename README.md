...
**Description**  
WebPPT is an AI-native presentation template for building interactive, version-controlled decks with plain HTML, CSS, and JavaScript. Compared with conventional PPT files, it keeps structure and style easy to reuse, supports formulas and live demos natively, and lets authors revise content by giving clear editing instructions to an AI coding assistant instead of manually adjusting slide objects.
